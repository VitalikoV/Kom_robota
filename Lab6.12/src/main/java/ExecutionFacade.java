...
public class ExecutionFacade {
    ...
    public static void executeWithList() throws Exception {
...
//        routes.add(new Route(113, "Sumy", "Lviv"));
    ...
    public static void executeWithBinaryTree() throws IOException {
        BufferedReader reader = new BufferedReader(
                new InputStreamReader(System.in));
        ...
        for (Route route : routes) {
            binaryTree.add(route);
        }

        binaryTree.printTree();

        System.out.println(binaryTree.get(112));
    }
}
